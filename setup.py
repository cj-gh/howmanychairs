...
.. moduleauthor:: Clemens Jochum <clemens@jochum.email>
"""
...
setup(
    name='howmanychairs',
    description="Command-line application for Apt. and Chair Delivery LTd.: use a floor plan to count chairs in the appartment and in each individual room.",
    ...
    entry_points="""
    [console_scripts]
    howmanychairs=howmanychairs.cli:cli
    """,
    python_requires=">=0.0.1",
    license='MIT',  # noqa
    author='Clemens Jochum',
    author_email='clemens@jochum.email',
    # Use the URL to the github repo.
    url= 'https://github.com/cj-gh/howmanychairs',
    download_url=(
        f'https://github.com/cj-gh/'
        f'howmanychairs/archive/{version}.tar.gz'
    ),
    keywords=[
